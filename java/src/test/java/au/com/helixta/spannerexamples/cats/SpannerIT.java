...
class SpannerIT
{
    ...
    private static final SpannerMutations spannerMutations = new SpannerMutations(SpannerOptions.newBuilder().setEmulatorHost(EMULATOR_URI).build()
                                                                                                .getService(), DATABASE_ID);
    @Autowired
